...
| 2026-09-08 | Silkscreen is meh; DotGothic16 is right where it is, the tile face is not; wants an artifact to toggle fonts per component | to do: type lab at https://claude.ai/code/artifact/301a1691-823a-4188-a921-f67887cc7aef (18 faces, six roles, sizes flagged when off a face's grid, readout line to paste back); next step is Dean's readout, then a PR that vendors the chosen faces and sets the role tokens |
