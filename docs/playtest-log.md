...
| 2026-09-08 | Tester batch: your name and the opponent's appear in several places on one screen | to do: clarity PR after run history, before starting cells; names once, on the bars |
| 2026-09-08 | Tester batch: the background is a little busy | to do: clarity PR; backdrop layers at lower opacity, slower drift |
| 2026-09-08 | Tester batch: it should be clearer when you have attacked and moved on from the last action | to do: clarity PR; a turn cue (the report line steps in with the turn number, the grid dims for a beat) |
| 2026-09-08 | Tester batch: show what the opponent's next action will be, Slay the Spire style | to do: clarity PR; an intent line on the enemy computed from the state (hits for N next turn, skips while stunned, special in K turns); no engine change needed |
