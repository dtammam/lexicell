...
| 2026-09-08 | A 200-item pool | in progress: scope confirmed and pack updated (PR #33); Dean agreed all six plan questions; engine PR #39 ships the nine verbs, seven conditions, onPick, offer rule and save v3; PR #41 ships the UI and batch 1 (112 items, curve D, criteria pass); batches 2-4 next |
...
| 2026-09-08 | Effects wave in full, then run history, then a set of starting cells (balanced, aggressive, defensive) | in progress: batch 2 shipped (PR #45, 157 items); batch 3 next, then run history, then starting cells with numbered questions |
