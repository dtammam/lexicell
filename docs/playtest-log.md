...
| 2026-09-08 | A 200-item pool | in progress: scope confirmed and pack updated (PR #33); Dean agreed all six plan questions; engine PR #39 ships the nine verbs, seven conditions, onPick, offer rule and save v3; next the UI PR with content batch 1, then batches 2-4 |
