...
- **This is NOT a game-engine project.** No Phaser, no Godot, no canvas rendering. DOM and CSS. (Exception, Dean 2026-09-15: an offscreen canvas may be used to EXPORT a share-image card - see src/ui/shareCard.ts. The game itself still renders as DOM/Svelte; this is a picture export only, and adds no dependency.)
