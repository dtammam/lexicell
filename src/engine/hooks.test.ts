...
const content: Content = { items: ITEMS, cells: [], enemies: [], bosses: [], encounters: [], events: [], traits: [], playerMaxHp: 100, tuning: { lengthBonus: [1], startingPicks: 0, venomMax: 4, poisonMax: 12, shieldMax: 30, perUnitMultCap: 1.5, enrageAfter: 20, enragePerTurn: 1, restHeal: 0.3, eliteHpScale: 1.3, eliteDamageScale: 1.15, endlessHpGrowth: 1.1, endlessDamageGrowth: 1.06 } };
