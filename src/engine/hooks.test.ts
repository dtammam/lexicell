...
const content: Content = { items: ITEMS, cells: [], enemies: [], bosses: [], encounters: [], playerMaxHp: 100, tuning: { lengthBonus: [1], startingPicks: 0, venomMax: 4, poisonMax: 12, shieldMax: 30, perUnitMultCap: 1.5 } };
