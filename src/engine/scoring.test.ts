...
const T: Tuning = { lengthBonus: [1, 1, 1, 1, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5, 5.5, 6, 6.5], startingPicks: 0, venomMax: 4, poisonMax: 12, shieldMax: 30, perUnitMultCap: 1.5, enrageAfter: 20, enragePerTurn: 1, restHeal: 0.3, eliteHpScale: 1.3, eliteDamageScale: 1.15, endlessHpGrowth: 1.06, endlessDamageGrowth: 1.08, endlessLap: 8, endlessHpAccel: 0.02 };
...
describe('scoring placeholder formula', () => {
  ...
  it('length bonus reads the table and clamps past its end', () => {
    ...
    expect(() => lengthBonus(3, { lengthBonus: [], startingPicks: 0, venomMax: 4, poisonMax: 12, shieldMax: 30, perUnitMultCap: 1.5, enrageAfter: 20, enragePerTurn: 1, restHeal: 0.3, eliteHpScale: 1.3, eliteDamageScale: 1.15, endlessHpGrowth: 1.06, endlessDamageGrowth: 1.08, endlessLap: 8, endlessHpAccel: 0.02 })).toThrow(RangeError);
  });
