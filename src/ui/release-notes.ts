...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  { build: 69, pr: 67, sha: 'pending', date: '2026-09-10', title: 'Fits your phone', notes: 'The whole game now fits a portrait phone screen without scrolling, even in iOS Safari with its address bar and toolbar showing. Long enemy names no longer shove the HP number out of its box; the name trims with an ellipsis instead.' },
