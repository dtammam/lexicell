...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  { build: 81, pr: 79, sha: 'pending', date: '2026-09-10', title: 'Distinct organelles', notes: "The organelle icons are far more varied now: the many that used to share a single glyph each get their own, still drawn in the same little pixel style. No two organelle icons look the same anymore." },
