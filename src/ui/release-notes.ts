...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  { build: 68, pr: 66, sha: 'pending', date: '2026-09-10', title: 'Endless mode', notes: 'Pick Normal or Endless with your cell. Normal is the nine encounters you know. Endless keeps going past the ninth: the deep sends its creatures on a curve that grows every fight, a boss every third, an evolution after each, until the deep takes you. History records how far you got.' },
