...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  { build: 70, pr: 68, sha: 'pending', date: '2026-09-10', title: 'A proper README', notes: 'The project has a real README now, with a cover image, phone screenshots and a short guide to running your own copy. Nothing changed in the game itself.' },
