...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  { build: 76, pr: 74, sha: 'pending', date: '2026-09-10', title: 'Bigger logo', notes: "The Lexicell logo on the title screen is a proper size now, and the build number shown there matches the release notes on every version. Nothing else changed in the game." },
