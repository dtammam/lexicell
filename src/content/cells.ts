...
export const CELLS: readonly CellDef[] = [
  ...
  },
  {
    id: 'defensive',
    name: 'Diatom',
    description: '115 HP. Take 2 less damage from every hit, but -15% damage.',
    flavor: 'Glass walls. Patient inside.',
    maxHp: 115,
    startingItems: [],
    extraPicks: 0,
    traits: { onDamageTaken: [{ type: 'reduceDamage', value: 2 }], onWordScored: [{ type: 'addMult', value: -0.15 }] },
  },
  {
    id: 'gambler',
    name: 'Spore',
    description: '90 HP. Words of 6+ letters deal +50%; words of 3 letters deal half.',
    ...
    traits: {
      onWordScored: [
        { type: 'condition', when: { kind: 'minLength', value: 6 }, then: [{ type: 'addMult', value: 0.5 }] },
