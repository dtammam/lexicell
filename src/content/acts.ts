...
export const TUNING: Tuning = {
  ...
  startingPicks: 1,
  venomMax: 4,
  // Effects wave (2026-09-08): poison is a bounded burn, the shield a bounded buffer, and a perUnit
  // addMult never compounds past x2.5 total (1 + 1.5).
  poisonMax: 12,
  shieldMax: 30,
  perUnitMultCap: 1.5,
};
...
export const ENCOUNTERS: readonly EncounterDef[] = [
  ...
  { act: 3, boss: false, hpScale: 3.1, damageScale: 2.8 },
  { act: 3, boss: false, hpScale: 3.5, damageScale: 3.1 },
  { act: 3, boss: true, hpScale: 3.0, damageScale: 3.2 },
];
