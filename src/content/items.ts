...
export const ITEMS: readonly ItemDef[] = [
  {
    ...
    name: 'Flagellum',
    rarity: 'common',
    description: '+8 damage on every word. A lash behind every syllable.',
  ...
  },
  {
    ...
    name: 'Photoreceptor',
    rarity: 'uncommon',
    description: '+70% damage. It sees where the weak spot is.',
  ...
  },
  {
    ...
    name: 'Vacuole',
    rarity: 'common',
    description: 'Vowels are drawn 80% more often. It stores what you keep running out of.',
  ...
  },
  {
    ...
    name: 'Mitosis',
    rarity: 'common',
    description: 'Heal 20 after each encounter. Split, recover, continue.',
  ...
  },
  {
    ...
    name: 'Membrane',
    rarity: 'uncommon',
    description: 'Take 4 less damage from every hit. Thicker than it looks.',
  ...
  },
  {
    ...
    name: 'Enzyme',
    rarity: 'uncommon',
    description: 'J, Q, X and Z are worth +10 each. It catalyses the awkward letters.',
  ...
  },
  {
    ...
    name: 'Cilia',
    rarity: 'uncommon',
    description: 'Heal 4 on every word of 5+ letters. Every long word sweeps in a little life.',
    hooks: {
  ...
  },
  {
    ...
    name: 'Spores',
    rarity: 'common',
    description: 'Deal 6 damage to the enemy at the start of each turn. They drift, they land, they burn.',
  ...
  // more items from the existing vocabulary; rule-benders wait for new effect types.
  {
    ...
    name: 'Lysosome',
    rarity: 'common',
    description: 'Words of 4 letters or fewer deal +10. Small, sharp, everywhere.',
  ...
  },
  {
    ...
    name: 'Pilus',
    rarity: 'common',
    description: 'Words containing S deal +8. It grips.',
  ...
  },
  {
    ...
    name: 'Chloroplast',
    rarity: 'common',
    description: 'Heal 3 at the start of every turn. Sunlight, slowly.',
  ...
  },
  {
    ...
    name: 'Cell Wall',
    rarity: 'common',
    description: 'While below half HP, take 6 less damage from every hit. It stiffens under stress.',
  ...
  },
  {
    ...
    name: 'Nucleus',
    rarity: 'common',
    description: 'Every vowel in a word is worth +3. The centre holds.',
  ...
  },
  {
    ...
    name: 'Plasmid',
    rarity: 'common',
    description: 'Every second turn, +70% damage. Borrowed genes, on loan.',
  ...
  },
  {
    ...
    name: 'Peroxisome',
    rarity: 'uncommon',
    description: 'Words of 5+ letters deal +15. It breaks things down.',
  ...
  },
  {
    ...
    name: 'Golgi Body',
    rarity: 'uncommon',
    description: 'L, N, R, S and T are worth +4 each. It packages the ordinary.',
  ...
  },
  {
    ...
    name: 'Centriole',
    rarity: 'uncommon',
    description: 'Every third turn, deal 18 damage at the start of the turn. It pulls things apart.',
  ...
  },
  {
    ...
    name: 'Symbiont',
    rarity: 'uncommon',
    description: 'Heal 30 after each encounter, but lose 1 HP at the start of every turn. It eats too.',
  ...
  },
  {
    ...
    name: 'Regeneration',
    rarity: 'rare',
    description: 'Heal 2 whenever you take damage. It grows back.',
  ...
  },
  {
    ...
    name: 'Cyst',
    rarity: 'rare',
    description: 'While below 30% HP, heal 4 whenever you take damage. Harden when it hurts.',
    hooks: {
