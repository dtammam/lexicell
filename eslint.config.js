...
export default tseslint.config(
  ...
  },
  {
    ...
    languageOptions: {
      ...
      globals: Object.fromEntries(['window', 'document', 'navigator', 'localStorage', 'console', 'setTimeout', 'clearTimeout', 'requestAnimationFrame', 'URL', 'fetch', 'Date', 'Math', 'JSON', 'Error', 'String', 'Number', 'Array', 'Object', 'Set', 'Map', 'Promise', '__BUILD_SHA__', '__BUILD_NUMBER__'].map((g) => [g, 'readonly'])),
