...
- **build 77 / PR #75** - The persistent top-bar app name is now the Bookends wordmark logo instead of the word "Lexicell", sized to match the text it replaced so the header footprint is unchanged.
